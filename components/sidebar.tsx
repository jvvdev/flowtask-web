...
import { Ri24HoursFill, RiFullscreenExitLine, RiFullscreenLine, RiLayoutLeft2Line, RiLayoutLeftLine, RiSkipLeftLine } from "@remixicon/react";
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      {!isOutsideSidebar ? (
        <RiFullscreenLine className="size-5 text-zinc-400" size={20} />
      ) : (
        <RiFullscreenExitLine className="size-5 text-zinc-400" size={20} />
      )}
