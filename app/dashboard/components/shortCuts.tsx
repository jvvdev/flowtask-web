    ...
    return (
        <div className="p-4 space-y-2 w-full h-62 max-h-[400px] border border-border bg-gradient-to-br from-sidebar/60 to-sidebar rounded-lg flex flex-col">
            ...
            <div className="flex flex-col gap-3 flex-1">
                <button className="flex p-4 gap-2 w-full border border-border rounded-md flex-1 hover:text-white hover:bg-gradient-to-br hover:from-green-500/50 hover:to-green-500/80 duration-300 transition">
