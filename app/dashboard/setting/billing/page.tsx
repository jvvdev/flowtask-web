...
export default function Settings() {
    ...
    function onSubmit(data: any) {
        console.log(data)
        planService.createCustomer(data)
        reset()
        setCurrentTab(1)
    }
                ...
                <div className="flex flex-1 flex-col gap-4 lg:gap-6 py-4 lg:py-6">
                    <div className="max-w-7xl mx-auto px-4 py-8">
                        <div className="flex flex-col lg:flex-row lg:gap-8">
                            {/* Left Column - Form */}
                            <div className="lg:col-span-2 w-full lg:w-[80%]">
                                <h1 className="text-3xl font-bold text-gray-900 mb-8">Pagamento</h1>

                                {/* Personal Data Section */}
                                <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg border mb-6 p-6">
                                    {
                                        currentTab === 0 ?
                                            <div className="space-y-6">
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-500">Para continuar sua compra preencha os campos para prosseguir aos proximos passos</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="space-y-6">
                                                ...
                                                <div className="space-y-4">
                                                    {/* plan, customer_id, cpf_cnpj, cep, address_number, phone, card_name, card_number, card_cvv, card_expiry_month, card_expiry_year  */}
                                                        ...
                                                        <div className="w-full">
                                                            ...
                                                            <Input
                                                                ...
                                                                {...register("cep", {
                                                                    ...
                                                                    maxLength: { value: 9, message: "CEP deve ter 8 dígitos" },
                                                                    pattern: {
                                                                        value: /^[0-9]{5}-[0-9]{3}$/,
